...
source_folder="../testcases/ast_testcases"
# Destination folder for output of testcases from parser
root_folder="../output"
ast_folder="../output/ast_cases"
intermediate_folder="../output/ast_cases/dot"
destination_folder1="../output/ast_cases/ast"
destination_folder2="../output/ast_cases/parse"
